...
class domain(models.Model):
    domain_name = models.CharField('域名', unique = True, max_length = 50, help_text = "业务域名")
...
class domain_https(models.Model):
    domain_https_name = models.CharField('域名', unique = True, max_length = 50, help_text = "业务域名")
